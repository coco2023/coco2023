...
|---|---|---|---|---|
|[[UmiUni-Shop](https://www.quickmall24.com)] <br> [[UmiUni-ERP](https://www.quickmall24.com/supplier-ims/3)]  | Dev-test Mode | UmiUni | **SpringBoot + ReactJS** | Independent |
...
- ⚡ **UmiUni FullStack**: an ERP integrated E-commerce website for second-hand goods, enable **PayPal**, **Stripe** as Payment Methods.
